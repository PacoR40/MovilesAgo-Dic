...
class _profileEditScreenState extends State<profileEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    txtContName.text = widget.profile.name!;
    txtContMail.text = widget.profile.mail!;
    txtContNumber.text = widget.profile.number!;
    txtContGit.text = widget.profile.github!;
